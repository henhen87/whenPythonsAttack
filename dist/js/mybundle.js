...
__webpack_require__.d(time_namespaceObject, "SET_SECONDS", function() { return SET_SECONDS; });
__webpack_require__.d(time_namespaceObject, "SET_MINUTES", function() { return SET_MINUTES; });
__webpack_require__.d(time_namespaceObject, "SET_HOURS", function() { return SET_HOURS; });
__webpack_require__.d(time_namespaceObject, "SET_DAYS", function() { return SET_DAYS; });
__webpack_require__.d(time_namespaceObject, "setSeconds", function() { return setSeconds; });
__webpack_require__.d(time_namespaceObject, "setMinutes", function() { return setMinutes; });
__webpack_require__.d(time_namespaceObject, "setHours", function() { return setHours; });
__webpack_require__.d(time_namespaceObject, "setDays", function() { return setDays; });
    ...
    function makeChildElementSelector() {
      ...
      return function selectChildElement(childProps, forwardRef) {
        if (childProps !== lastChildProps || forwardRef !== lastForwardRef) {
          ...
          lastChildElement = react_default.a.createElement(FinalWrappedComponent, extends_extends({}, childProps, {
            ref: forwardRef
          }));
        }
...
// CONCATENATED MODULE: ./actions/time.js
var SET_SECONDS = 'SET_SECONDS';
var SET_MINUTES = 'SET_MINUTES';
var SET_HOURS = 'SET_HOURS';
var SET_DAYS = 'SET_DAYS';
var setSeconds = function setSeconds(time) {
  return {
    type: 'SET_SECONDS',
    payload: time
  };
};
var setMinutes = function setMinutes(time) {
  return {
    type: 'SET_MINUTES',
    payload: time
  };
};
var setHours = function setHours(time) {
  return {
    type: 'SET_HOURS',
    payload: time
  };
};
var setDays = function setDays(time) {
  return {
    type: 'SET_DAYS',
    payload: time
  };
};
// CONCATENATED MODULE: ./reducers/time.js
function time_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { time_defineProperty(target, key, source[key]); }); } return target; }
...
var sass = __webpack_require__(11);
var sass_default = /*#__PURE__*/__webpack_require__.n(sass);

// CONCATENATED MODULE: ./components/Digit.js
function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = Digit_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
...
var Digit_Digit = function Digit(_ref) {
  var flip = _ref.flip,
      flipBot = _ref.flipBot,
      digit = _ref.digit,
      props = _objectWithoutProperties(_ref, ["flip", "flipBot", "digit"]);

  console.log('FLIP SEC', flipBot);
  var FLIP_CLASS = flip === true;
  var FLIP_CLASS_BOT = flipBot === true;
  return react_default.a.createElement("div", {
    ...
    className: "backNum"
  }, digit === 0 ? digit : digit - 1)), react_default.a.createElement("div", {
    id: "backBot"
  }, react_default.a.createElement("h1", {
    className: flipBot === false ? 'backNum show' : 'backNum hide'
  }, digit === 0 ? digit : digit + 1)), react_default.a.createElement("div", {
    className: "num"
  }, react_default.a.createElement("div", {
    className: "top-container ".concat(FLIP_CLASS ? 'flip' : '')
  }, FLIP_CLASS ? react_default.a.createElement("div", {
    className: "overlayTop"
  }) : null, react_default.a.createElement("div", {
    className: "top"
  }, react_default.a.createElement("h1", null, digit))), react_default.a.createElement("div", {
    className: "divider"
  }), react_default.a.createElement("div", {
    className: "bottom-container ".concat(FLIP_CLASS_BOT ? 'flip' : '')
  }, react_default.a.createElement("div", {
    className: "bottom"
  }, react_default.a.createElement("h1", null, digit)))), react_default.a.createElement("div", {
    className: "label"
...
Digit_Digit.propTypes = {
  flip: prop_types_default.a.bool,
  flipBot: prop_types_default.a.bool,
  digit: prop_types_default.a.number.isRequired,
  className: prop_types_default.a.string,
  label: prop_types_default.a.string.isRequired
};
// CONCATENATED MODULE: ./components/Time.js
function Time_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Time_typeof = function _typeof(obj) { return typeof obj; }; } else { Time_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Time_typeof(obj); }
...
function Time_possibleConstructorReturn(self, call) { if (call && (Time_typeof(call) === "object" || typeof call === "function")) { return call; } return Time_assertThisInitialized(self); }

function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }

function Time_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }

function _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }

function Time_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var MILLI_SECS_HOUR = 1000 * 60 * 60;
var MILLI_SECS_DAY = 1000 * 60 * 60 * 24;

var Time_Time =
/*#__PURE__*/
function (_Component) {
  Time_inherits(Time, _Component);
  ...
  function Time() {
    ...
    _this = Time_possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Time)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "state", {
      flipSecs: false,
      flipSecsBot: false,
      flipMinBot: false,
      flipHourBot: false,
    ...
    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "_botNumIntervalFunc", null);

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "_initTimeIntervalFunc", null);

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "_seconds", Math.floor(_this.props.currentTime / 1000 % 60));

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "_minutes", Math.floor(_this.props.currentTime / 1000 / 60 % 60));

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "_hours", Math.floor(_this.props.currentTime / MILLI_SECS_HOUR % 24));

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "_days", Math.floor(_this.props.currentTime / MILLI_SECS_DAY));

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "setFlipSecs", function () {
      return _this.setState({
        flipSecs: !_this.state.flipSecs
      }, function () {
        return setTimeout(function () {
          _this.setState({
            flipSecsBot: !_this.state.flipSecsBot
          });
        }, 500);
      });
    });

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "setFlipMins", function () {
      return _this.setState({
        flipMinBot: true
      }, function () {
        return setTimeout(function () {
    ...
    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "setFlipHours", function () {
      return _this.setState({
        flipHourBot: true
      }, function () {
        return setTimeout(function () {
    ...
    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "setFlipDays", function () {
      return _this.setState({
        flipDayBot: true
      }, function () {
        return setTimeout(function () {
    ...
    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "initializeTime", function () {
      _this._seconds = _this.getSeconds();
    });

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "getSeconds", function () {
      if (_this._seconds === 0) {
    ...
    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "getMinuntes", function () {
      if (_this._minutes === 0) {
        _this._hours = _this.getHours();
        return 59;
      } else {
        return _this._minutes - 1;
      }
    });

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "getHours", function () {
      if (_this._hours === 0) {
        _this._days = _this.getDays();
        return 24;
      } else {
        return _this._hours - 1;
      }
    });

    Time_defineProperty(Time_assertThisInitialized(Time_assertThisInitialized(_this)), "getDays", function () {
      if (_this._days === 0) {
        return 365;
      } else {
        return _this._days - 1;
      }
    });
...
Time_defineProperty(Time_Time, "propTypes", {
  currentTime: prop_types_default.a.number.isRequired
});

/* harmony default export */ var components_Time = (Time_Time);
// CONCATENATED MODULE: ./components/Clock.js
function Clock_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Clock_typeof = function _typeof(obj) { return typeof obj; }; } else { Clock_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Clock_typeof(obj); }
...
function Clock_possibleConstructorReturn(self, call) { if (call && (Clock_typeof(call) === "object" || typeof call === "function")) { return call; } return Clock_assertThisInitialized(self); }

function Clock_getPrototypeOf(o) { Clock_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Clock_getPrototypeOf(o); }

function Clock_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Clock_setPrototypeOf(subClass, superClass); }

function Clock_setPrototypeOf(o, p) { Clock_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Clock_setPrototypeOf(o, p); }

function Clock_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var NEXT_NEW_YEAR = '1/1/2020';

var Clock_Clock =
/*#__PURE__*/
function (_Component) {
  Clock_inherits(Clock, _Component);
  ...
  function Clock() {
    ...
    _this = Clock_possibleConstructorReturn(this, (_getPrototypeOf2 = Clock_getPrototypeOf(Clock)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Clock_defineProperty(Clock_assertThisInitialized(Clock_assertThisInitialized(_this)), "state", {
      currentTime: null
    });
  ...
  Clock_createClass(Clock, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "clock"
      }, react_default.a.createElement(components_Time, Clock_extends({}, this.props, {
...
var Clock_mapStateToProps = function mapStateToProps(state) {
  return {
...
var Clock_mapDisptachToProps = function mapDisptachToProps(dispatch) {
  return bindActionCreators(time_namespaceObject, dispatch);
};

/* harmony default export */ var components_Clock = (connect_connect(Clock_mapStateToProps, Clock_mapDisptachToProps)(Clock_Clock));
...
console.log('STYLE', sass_default.a);
...
function (_Component) {
  ...
  function Home() {
    ...
    Home_defineProperty(Home_assertThisInitialized(Home_assertThisInitialized(_this)), "render", function () {
      return react_default.a.createElement("div", {
        id: "home"
      }, react_default.a.createElement("h1", {
        className: "main-header"
      }, "Happy New Year ", react_default.a.createElement("br", null), "2020 Count Down"), react_default.a.createElement(components_Clock, null));
    });
...
/* harmony default export */ var containers_Home = (Home_Home);
...
var index_store = createStore(reducers_0);
Object(react_dom["render"])(react_default.a.createElement(components_Provider, {
  store: index_store
}, react_default.a.createElement(es_BrowserRouter, null, react_default.a.createElement(react_router_dom_es_Switch, null, react_default.a.createElement(react_router_dom_es_Route, {
  path: "/",
