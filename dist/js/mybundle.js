...
var Digit_Digit = function Digit(_ref) {
  ...
  }, react_default.a.createElement("h1", null, digit - 1), react_default.a.createElement("div", {
    className: "top ".concat(flip === true ? 'flip' : '')
  }, react_default.a.createElement("h1", null, digit))), react_default.a.createElement("div", {
    className: "bottom-container"
  }, react_default.a.createElement("h1", {
    className: flipSecsBot === false ? 'show' : ''
  }, digit), react_default.a.createElement("div", {
    className: "bottom ".concat(flipSecsBot === true ? 'flip' : '')
  }, react_default.a.createElement("h1", null, digit)))), react_default.a.createElement("div", {
    className: "label"
  }, props.label));
};
Digit_Digit.propTypes = {
  ...
  flipSecsBot: prop_types_default.a.bool,
...
function Time_possibleConstructorReturn(self, call) { if (call && (Time_typeof(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized(self); }
...
function (_Component) {
  ...
  function Time() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_botNumIntervalFuncTwo", null);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_seconds", 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_minutes", 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_hours", 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_days", 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setFlipSecs", function () {
      console.log('FLIP SECSS BEFORE', _this._flipSecs); // this._flipSecs = !this._flipSecs

      _this.setState({
        flipSecs: !_this.state.flipSecs
      });

      console.log('FLIP SECSS AFTER', _this._flipSecs);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setBotFlipSecs", function () {
      _this.setState({
        flipSecsBot: true
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "initializeTime", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getSeconds", function () {
      return Math.floor(_this.props.currentTime / 1000 % 60);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMinuntes", function () {
      return Math.floor(_this.props.currentTime / 1000 / 60 % 60);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getHours", function () {
      return Math.floor(_this.props.currentTime / MILLI_SECS_HOUR % 24);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getDays", function () {
      return Math.floor(_this.props.currentTime / MILLI_SECS_DAY);
    });
...
_defineProperty(Time_Time, "propTypes", {
...
function (_Component) {
  ...
  function Clock() {
    ...
    Clock_defineProperty(Clock_assertThisInitialized(Clock_assertThisInitialized(_this)), "_timerFunctionInt", null);

    Clock_defineProperty(Clock_assertThisInitialized(Clock_assertThisInitialized(_this)), "_timerFunctionSet", null);

    Clock_defineProperty(Clock_assertThisInitialized(Clock_assertThisInitialized(_this)), "getTimeRemaining", function () {
      return _this.setState({
  ...
  Clock_createClass(Clock, [{
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        _this2._timerFunctionInt = setInterval(_this2.getTimeRemaining, 1000);
      }, 3000);
    }
  }, {
    key: "componentWillUnmount",
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "clock"
      }, react_default.a.createElement("h1", null, "2020 Count Down!!"), react_default.a.createElement(components_Time, {
...
/* harmony default export */ var components_Clock = (Clock_Clock);
...
function (_Component) {
  ...
  function Home() {
    ...
    Home_defineProperty(Home_assertThisInitialized(Home_assertThisInitialized(_this)), "render", function () {
      return react_default.a.createElement("div", {
        id: "home"
      }, react_default.a.createElement(components_Clock, null));
    });
...
Object(react_dom["render"])(react_default.a.createElement(es_BrowserRouter, null, react_default.a.createElement(react_router_dom_es_Switch, null, react_default.a.createElement(react_router_dom_es_Route, {
  path: "/",
