...
var Digit_Digit = function Digit(_ref) {
  ...
  return react_default.a.createElement("div", {
    ...
    className: flipSecsBot === false ? 'backNum show' : 'backNum hide'
  }, digit === 0 ? digit : digit + 1)), react_default.a.createElement("div", {
    className: "num"
  }, react_default.a.createElement("div", {
...
function (_Component) {
  ...
  function Time() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_initTimeIntervalFunc", null);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_seconds", Math.floor(_this.props.currentTime / 1000 % 60));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_minutes", Math.floor(_this.props.currentTime / 1000 / 60 % 60));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_hours", Math.floor(_this.props.currentTime / MILLI_SECS_HOUR % 24));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_days", Math.floor(_this.props.currentTime / MILLI_SECS_DAY));
...
function (_Component) {
  ...
  Clock_createClass(Clock, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "clock"
      }, react_default.a.createElement(components_Time, {
